# Generated by Django 3.1.4 on 2021-02-18 02:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pinky_one', models.IntegerField(blank=True, null=True)),
                ('ring_one', models.IntegerField(blank=True, null=True)),
                ('middle_one', models.IntegerField(blank=True, null=True)),
                ('index_one', models.IntegerField(blank=True, null=True)),
                ('pinky_two', models.IntegerField(blank=True, null=True)),
                ('ring_two', models.IntegerField(blank=True, null=True)),
                ('middle_two', models.IntegerField(blank=True, null=True)),
                ('index_two', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'verbose_name': 'user',
